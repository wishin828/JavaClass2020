    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (!products.isEmpty()) {
                ...
                content.append("<div class='error'>Unable to find any products matching name '"+name+"'</div>");
            }
            ...
            out.println("<nav class='nav'><a href='/pm/ProductSearch.html'>Product Search</a></nav>");
